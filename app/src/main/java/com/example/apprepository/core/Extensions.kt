package com.example.apprepository.core
...
fun Context.createProgressDialog(): AlertDialog {
    return createDialog {
        val padding = this@createProgressDialog.resources.getDimensionPixelOffset(androidx.core.R.dimen.notification_right_icon_size)
