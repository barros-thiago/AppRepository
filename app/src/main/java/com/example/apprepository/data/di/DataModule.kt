package com.example.apprepository.data.di


import android.util.Log
import com.example.apprepository.data.repositories.RepoRepository
import com.example.apprepository.data.repositories.RepoRepositoryImpl
...
object DataModule {
    ...
    private fun networkModules(): Module{
        return module {
            ...
            single { createService<GitHubService>(get(),get()) }
